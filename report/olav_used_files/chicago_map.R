...
avg_waiting_time_map <- function(chicago_leaflet, areas_pickup_time, label_avg_pickup_time, 
                                 time_pal, waiting_time_labels) {
...
avg_waiting_time_map <- function(chicago_leaflet, areas_hourly_rate, label_avg_hourly_rate, 
                                 hourly_pal, hourly_labels) {
  chicago_leaflet %>%
